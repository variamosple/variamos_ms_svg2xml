...
package com.example.Svg2xmlMS.svg2xml;

import com.mxgraph.shape.mxStencilShape;
import com.example.Svg2xmlMS.svg2xml.XmlConfig.aspectType;
...
//		}
		...
		svg2Xml.convertToXml(sourceFiles.toArray(new File[0]));
	}
	...
	public String convertToXml(File[] sourceFiles) {
		// order of actions:
